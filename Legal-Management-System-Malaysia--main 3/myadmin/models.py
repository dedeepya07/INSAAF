...
class Invoice(models.Model):
    ...
    total_reimbur_service_price = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True)
    total_prof_service_price = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True)
    ...
    temporary_field = models.CharField(max_length=10, null=True, blank=True)  # Add this line
